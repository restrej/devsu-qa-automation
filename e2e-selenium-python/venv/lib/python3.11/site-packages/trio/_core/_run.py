...
class CancelScope:
    ...
    def deadline(self) -> float:
        ...
        Note that for efficiency, the devsu run loop only checks for
...
################################################################
#
# Trio's devsu task scheduler and coroutine runner is in 'unrolled_run'. It's
...
# mode", where our devsu event loop gets unrolled into a series of callbacks on
