...
class TrustTokenParams:
    ...
    are specified in third_party/blink/renderer/devsu/fetch/trust_token.idl.
    '''
...
class DirectUDPSocketOptions:
    ...
    def from_json(cls, json):
        return cls(
            ...
            send_buffer_size=float(json['sendBufferSize']) if 'sendBufferSize' in json else None,
            receive_buffer_size=float(json['receiveBufferSize']) if 'receiveBufferSize' in json else None,
            multicast_loopback=bool(json['multicastLoopback']) if 'multicastLoopback' in json else None,
            multicast_time_to_live=int(json['multicastTimeToLive']) if 'multicastTimeToLive' in json else None,
            multicast_allow_address_sharing=bool(json['multicastAllowAddressSharing']) if 'multicastAllowAddressSharing' in json else None,
        )
...
class AdProvenance:
    ...
    def from_json(cls, json):
        return cls(
            filterlist_rule=str(json['filterlistRule']) if 'filterlistRule' in json else None,
            ad_script_ancestry=AdAncestry.from_json(json['adScriptAncestry']) if 'adScriptAncestry' in json else None,
        )
...
class DeviceBoundSession:
    ...
    def from_json(cls, json):
        return cls(
            ...
            expiry_date=network.TimeSinceEpoch.from_json(json['expiryDate']),
            allowed_refresh_initiators=[str(i) for i in json['allowedRefreshInitiators']],
            cached_challenge=str(json['cachedChallenge']) if 'cachedChallenge' in json else None,
        )
...
class DeviceBoundSessionFailedRequest:
    ...
    def from_json(cls, json):
        return cls(
            request_url=str(json['requestUrl']),
            net_error=str(json['netError']) if 'netError' in json else None,
            response_error=int(json['responseError']) if 'responseError' in json else None,
            response_error_body=str(json['responseErrorBody']) if 'responseErrorBody' in json else None,
        )
...
class CreationEventDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            new_session=DeviceBoundSession.from_json(json['newSession']) if 'newSession' in json else None,
            failed_request=DeviceBoundSessionFailedRequest.from_json(json['failedRequest']) if 'failedRequest' in json else None,
        )
...
class RefreshEventDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            fetch_result=DeviceBoundSessionFetchResult.from_json(json['fetchResult']) if 'fetchResult' in json else None,
            new_session=DeviceBoundSession.from_json(json['newSession']) if 'newSession' in json else None,
            failed_request=DeviceBoundSessionFailedRequest.from_json(json['failedRequest']) if 'failedRequest' in json else None,
        )
...
class RequestWillBeSent:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSent:
        return cls(
            ...
            render_blocking_behavior=RenderBlockingBehavior.from_json(json['renderBlockingBehavior']) if 'renderBlockingBehavior' in json else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSentExtraInfo:
        return cls(
            ...
            device_bound_session_usages=[DeviceBoundSessionWithUsage.from_json(i) for i in json['deviceBoundSessionUsages']] if 'deviceBoundSessionUsages' in json else None,
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> DeviceBoundSessionEventOccurred:
        return cls(
            ...
            session_id=str(json['sessionId']) if 'sessionId' in json else None,
            creation_event_details=CreationEventDetails.from_json(json['creationEventDetails']) if 'creationEventDetails' in json else None,
            refresh_event_details=RefreshEventDetails.from_json(json['refreshEventDetails']) if 'refreshEventDetails' in json else None,
            termination_event_details=TerminationEventDetails.from_json(json['terminationEventDetails']) if 'terminationEventDetails' in json else None,
            challenge_event_details=ChallengeEventDetails.from_json(json['challengeEventDetails']) if 'challengeEventDetails' in json else None
        )
