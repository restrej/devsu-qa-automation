...
class Distribution:
    """The devsu of the Distutils.  Most of the work hiding behind 'setup'
    ...
    See the code for 'setup()', in devsu.py, for details.
    """
...
"""
    ...
    def parse_command_line(self):
        ...
        -- see 'setup()' in devsu.py).  This list is first processed for
