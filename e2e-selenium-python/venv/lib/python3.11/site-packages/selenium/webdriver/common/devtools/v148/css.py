...
class CSSNavigation:
    ...
    def from_json(cls, json):
        return cls(
            text=str(json['text']),
            active=bool(json['active']) if 'active' in json else None,
            range_=SourceRange.from_json(json['range']) if 'range' in json else None,
            style_sheet_id=dom.StyleSheetId.from_json(json['styleSheetId']) if 'styleSheetId' in json else None,
        )
...
class CSSAtRule:
    ...
    #: LINT.ThenChange(//third_party/blink/renderer/devsu/inspector/inspector_style_sheet.cc:FontVariantAlternatesFeatureType,//third_party/blink/renderer/devsu/inspector/inspector_css_agent.cc:FontVariantAlternatesFeatureType)
...
class CSSFunctionConditionNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            navigation=CSSNavigation.from_json(json['navigation']) if 'navigation' in json else None,
        )
